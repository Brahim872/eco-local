    ...
    <div class="w-full py-2 bg-white overflow-hidden">
        ...
        <div class=" mx-auto mt-4  rounded">
            ...
            <ul id="tabs" class="tabs-nav flex   space-x-2 overflow-x-auto overflow-y-hidden  flex-nowrap ">
                <li class="flex items-center flex-shrink-0 px-5 py-2 border-b-4 border-gray-700 text-gray-400"><a id="default-tab" href="#first">All</a></li>
                <li class="flex items-center flex-shrink-0 px-5 py-2 border-b-4 text-gray-400"><a href="#second">Clothes</a></li>
                <li class="flex items-center flex-shrink-0 px-5 py-2 border-b-4 text-gray-400"><a href="#third">Electronics</a></li>
                ...
                <div id="first" class="p-4">
                    ...
                    <form method="POST" action="{{ route('contact.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="py-2">
                            ...
                            >
                                ...
                                @foreach($companies as $id=>$company)
                                    <option value="{{$id}}"  @if(isset($model->company_id) && $model->company_id == $id) selected @endif>{{$company}}</option>
                                @endforeach
                            </x-admin.form.select>
                        ...
                        <div class="py-2">
                            ...
                            <x-admin.form.input id="first_name" class="{{$errors->has('name') ? 'border-red-400' : ''}} w-[50%]"
                                                type="text"
                                                name="first_name"
