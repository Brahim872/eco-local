    ...
    <div id="tab-contents">
        ...
        <div id="second" class="w-full py-2 mt-4  bg-white overflow-hidden hidden ">
            ...
            <form method="POST" action="{{ route('user.update.password',$user->id) }}" enctype="multipart/form-data">
                ...
                <div class="py-2">
                    <x-admin.form.label for="old_password"
                                        class="{{$errors->has('old_password') ? 'text-red-400' : ''}}">{{ __('old_password') }}</x-admin.form.label>

                    <x-admin.form.input id="old_password"
                                        class="{{$errors->has('old_password') ? 'border-red-400' : ''}} w-[50%]"
                                        type="password"
                                        name="old_password"
                ...
                <div class="py-2">
                    <x-admin.form.label for="new_password"
                                        class="{{$errors->has('new_password') ? 'text-red-400' : ''}}">{{ __('New password') }}</x-admin.form.label>

                    <x-admin.form.input id="new_password"
                                        class="{{$errors->has('new_password') ? 'border-red-400' : ''}} w-[50%]"
                                        type="password"
                                        name="new_password"
                ...
                <div class="py-2">
                    <x-admin.form.label for="confirm_password"
                                        class="{{$errors->has('confirm_password') ? 'text-red-400' : ''}}">{{ __('confirm_password') }}</x-admin.form.label>

                    <x-admin.form.input id="confirm_password"
                                        class="{{$errors->has('confirm_password') ? 'border-red-400' : ''}} w-[50%]"
                                        type="password"
