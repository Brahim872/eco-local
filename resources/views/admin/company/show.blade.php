                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="flex-none w-auto max-w-full px-3">
                                <div class="flex items-center justify-center w-28">
                                    <img src="{{$model->profile?asset('storage/'.$model->profile):"#"}}" alt="profile_image"
            ...
            <x-admin.grid.table>
                <x-slot name="head">
                    <tr class="text-md font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
                        ...
                        <x-admin.grid.th>
                            @include('admin.includes.sort-link', ['label' => 'Deactivaed_at', 'attribute' => 'deactivated_at'])
                        </x-admin.grid.th>
                        ...
                        <tr class="text-gray-700">
                            <x-admin.grid.td>
                                <div class="text-sm text-gray-900">
                                    <a href="{{route('company.show', $item->slug??'')}}" class="no-underline hover:underline text-cyan-600">{{ $item->first_name??'' }}</a>
                                </div>
                            </x-admin.grid.td>
                            <x-admin.grid.td>
                                <div class="text-sm text-gray-900">
