  ...
  toastr: {
    ...
    create: function (type, msg, options) {
      ...
      var time = options.time ? options.time : this.options.time,
        ...
        width = options.width ? options.width : this.options.width,
      ...
      this.container(position).find('> ul').prepend('<li style="width: '+width+'" class="' + size + ' fade-in-' + fades[position].fadeIn + ' ' + id + ' toastr-' + type + '">' + msg + '</li>');
